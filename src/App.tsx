            ...
            >
              <div className="booking-section">
                ...
                <div style={{ 
                  ...
                  padding: '3rem 2rem',
                  textAlign: 'center',
                  border: '2px dashed var(--albanian-red)'
                }}>
                  <Calendar size={48} color="var(--albanian-red)" style={{ margin: '0 auto 1rem' }} />
                  <h3 className="mb-2">Calendar Integration</h3>
                  <p className="mb-3">
                    Connect your Calendly, Cal.com, or custom booking system here.
                  </p>
