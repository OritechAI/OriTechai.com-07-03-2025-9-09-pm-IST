                  ...
                  {menu.map((item) => {
                    ...
                    return (
                      <NavigationMenuItem key={item.title}>
                        <a
                          className={`group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors ${isActive ? 'font-bold text-red-emphasis' : 'hover:text-gray-600'}`}
                          href={`#${item.sectionId}`}
                          onClick={(e) => { 
                            e.preventDefault(); 
        ...
        <div className="block lg:hidden">
          <div className="flex items-center justify-between">
            ...
            <Sheet>
              ...
              <SheetContent className="overflow-y-auto bg-gray-50 border-gray-200 z-[9999]">
                <SheetHeader>
                  <SheetTitle>
                    <a 
                      href="#home" 
                    ...
                    {menu.map((item) => {
                      ...
                      return (
                        <a 
                          ...
                          className={`flex items-center font-semibold ${isActive ? 'font-bold text-red-emphasis' : 'hover:text-gray-600'}`}
                        >
                  ...
                  <div className="border-t border-gray-200 py-4">
                    <div className="grid grid-cols-2 justify-start">
                      {mobileExtraLinks.map((link, idx) => (
                        <a
                          key={idx}
                          className="inline-flex h-10 items-center gap-2 whitespace-nowrap rounded-md px-4 py-2 text-sm font-medium transition-colors hover:text-gray-600"
                          href={`#${link.sectionId}`}
                          onClick={(e) => { 
                            e.preventDefault(); 
