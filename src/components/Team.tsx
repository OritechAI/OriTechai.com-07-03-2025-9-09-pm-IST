        ...
        >
          {team.map((member, index) => (
            <motion.div
              ...
              whileHover="hover"
              className="team-card text-center bg-oritech-gray/30 backdrop-blur-sm border border-oritech-gray/50 rounded-lg overflow-hidden shadow-[0_0_15px_rgba(206,0,5,0.15)]"
              initial="hidden"
              animate="visible"
            >
