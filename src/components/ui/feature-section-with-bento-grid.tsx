import { MessageSquare, Zap, Database, Code2 } from "lucide-react";
  ...
  const services = [
    {
      ...
      title: 'AI Chatbots',
      description: 'Intelligent agents that engage customers 24/7. Our chatbots provide instant support, qualify leads, and collect valuable customer data.',
    },
    {
      icon: <Zap className="w-8 h-8 stroke-1 text-oritech-red" />,
      title: 'AI Voice Agents',
      description: 'Natural voice assistants for seamless customer interactions. Our voice agents sound remarkably human and understand context.',
    },
    {
      icon: <Database className="w-8 h-8 stroke-1 text-oritech-red" />,
      title: 'B2B Lead Generation',
      description: 'AI-powered systems that identify quality leads efficiently. Target high-value prospects and automate outreach.',
    },
    {
      icon: <Code2 className="w-8 h-8 stroke-1 text-oritech-red" />,
      title: 'Custom AI Projects',
      description: 'Tailor-made solutions for your unique business challenges. We build custom AI applications designed specifically for your workflow.',
    }
  ];

  return (
    <div className="w-full py-20 lg:py-36 feature-grid">
      <div className="container mx-auto">
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-oritech-gray/30 backdrop-blur-sm rounded-md h-full lg:col-span-2 p-6 border border-oritech-gray/50 hw-accelerated transition-all duration-300 hover:bg-oritech-gray/40 shadow-[0_0_20px_rgba(206,0,5,0.15)] hover:shadow-[0_0_25px_rgba(206,0,5,0.25)]">
            ...
            <div className="bg-oritech-gray/30 backdrop-blur-sm rounded-md p-6 border border-oritech-gray/50 hw-accelerated transition-all duration-300 hover:bg-oritech-gray/40 shadow-[0_0_20px_rgba(206,0,5,0.15)] hover:shadow-[0_0_25px_rgba(206,0,5,0.25)]">
              <div className="flex items-center mb-4">
                {services[1].icon}
            ...
            <div id="custom-ai-card" className="bg-oritech-gray/30 backdrop-blur-sm rounded-md h-full lg:col-span-2 p-6 border border-oritech-gray/50 hw-accelerated transition-all duration-300 hover:bg-oritech-gray/40 shadow-[0_0_20px_rgba(206,0,5,0.15)] hover:shadow-[0_0_25px_rgba(206,0,5,0.25)]">
              <div className="flex items-center mb-4">
                {services[3].icon}
