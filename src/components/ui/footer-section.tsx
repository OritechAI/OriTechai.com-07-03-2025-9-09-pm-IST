                  ...
                  <TooltipTrigger asChild>
                    <span onClick={handleDarkModeToggle}>
                      <Switch
                        id="dark-mode"
                        checked={isDarkMode}
                        className="data-[state=checked]:bg-oritech-red cursor-not-allowed opacity-70"
                      />
                    </span>
                  </TooltipTrigger>
                  <TooltipContent className="bg-oritech-gray/80 text-white border-none">
                    <p className="font-poppins font-light">Unavailable for now</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
